...
export function CREATE_TABLE (
	options: FxOrmSqlDDLSync__SQL.TableOptions, driver: FxOrmSqlDDLSync__Driver.Driver
) {
...
export function ALTER_TABLE_ADD_COLUMN (
	options: FxOrmSqlDDLSync__SQL.AddColumnOptions, driver: FxOrmSqlDDLSync__Driver.Driver
) {
...
export function ALTER_TABLE_RENAME_COLUMN (
	opts: FxOrmSqlDDLSync__SQL.AlertColumnRenameOptions, driver: FxOrmSqlDDLSync__Driver.Driver
) {
...
export function ALTER_TABLE_MODIFY_COLUMN (
	options: FxOrmSqlDDLSync__SQL.AlterColumnOptions, driver: FxOrmSqlDDLSync__Driver.Driver
) {
	var sql = "ALTER TABLE " + driver.query.escapeId(options.name) +
...
export function CREATE_INDEX (
	options: FxOrmSqlDDLSync__SQL.IndexOptions, driver: FxOrmSqlDDLSync__Driver.Driver
) {
